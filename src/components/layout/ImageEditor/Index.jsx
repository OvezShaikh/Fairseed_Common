...
function YourComponent({ dataUrl, sx }) {
    ...
    return (
        <div className="w-[100%]">
            {!isFullScreen && (
                <div className=" w-full max-desktop:w-[100%]" style={{ ...sx, border: "2px dashed #3366CC", borderRadius: '12px', backgroundColor: dataUrl ? 'transparent' : '#F7FAFF', position: 'relative' }}>
                    {dataUrl ? (
