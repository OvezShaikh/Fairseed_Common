            ...
            <div className='flex mt-[24px]'>
              ...
              <div className='w-full'>
                <div className='flex justify-between'>
                  ...
                  <div>{Math.round((item.fund_raised / item.goal_amount) * 100)}% Completed</div>
                </div>
                <div>by {item.user.username}/{item.end_date}</div>
                <div className='w-full mt-[11px]'>
                  ...
                  <div className='h-[13px]'>
                    ...
                    <LinearProgress
                      ...
                      variant="determinate"
                      sx={{ height: "10px", borderRadius: "16px", background: `linear-gradient(to bottom,#ffe9d9,#FFd8e5)`, "& .MuiLinearProgress-bar": { background: 'linear-gradient(to right,#FF9F0A, #FF375F) !important  ',borderRadius: '100px', } }}
