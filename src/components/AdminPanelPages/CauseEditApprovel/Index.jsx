    ...
    return (
        ...
        >
            <Form className='flex flex-col items-center'>
                <div className="flex w-[100%] mt-2 gap-14 max-tablet:flex-col">
                    <div className="flex flex-col w-[70%] max-tablet:w-[100%] gap-10 items-center">
                        ...
                        {/* Display ImageDisplay component */}
                        {/* <ImageDisplay imageUrl={imageUrl} />
                        </div> */}
                        <div className="w-full">
                            <InputField sx={InputStyle} name={"TitleofCampaign"} label={"Title of Campaign:"} required={"true"} placeholder={"Minimum 50 INR"} />
                        </div>
                    ...
                    <div className="w-[30%] max-tablet:w-[100%] flex flex-col   gap-8">
                        <div className=" w-[100%]">
                            <ImageEditor
