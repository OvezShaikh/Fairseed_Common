                ...
                <div className="flex w-[100%] mt-2 gap-14">
                    <div className="flex flex-col w-[70%] gap-10 items-center">
                        <div className="flex flex-col items-center">
                            <div className="flex">
                              <h1 className='text-[18px] font-[satoshi] font-medium text-[#000000] underline pr-2'> Cause</h1>
                              <a href={`/campaign-details/${id}`} > <img src={images.CausesDetails} alt="" /> </a>
                            </div>
                            <p className='text-[18px] font-[satoshi] font-medium text-[#000000] '>Note: Labels in red color indicates that the field is changed.  </p>
                        </div>
                        <div className="w-full">
                            <InputField sx={InputStyle}
                        ...
                        <SelectField
                            ...
                            />
                        <div className="w-full">
                            <InputField sx={InputStyle} onChange={handleChange} type='number' name={"goal_amount"} value={values?.goal_amount} label={"Amount to be raised:"} placeholder={"Minimum 50 INR"} />
                        </div>
                        <InputField name={"location"} onChange={handleChange} value={values?.location} label={"Location:"} />
                        <div className="flex w-[100%] gap-4">
                            <div className="w-[50%]">
                                <InputField sx={InputStyle} onChange={handleChange} type={'date'} name={"end_date"} value={values?.end_date} label={"Accept Donations until (Select end date):"} placeholder={"Minimum 50 INR"} />
                            </div>
                        ...
                        <div className="w-full mt-5">
                            <InputField name={'summary'} onChange={handleChange} value={values?.summary} label={"Summary"} required={"true"}
                                multiline
                                info
                                CustomInfoIcon={
                                    <ErrorIcon
