      ...
      <Form className='flex flex-col justify-center flex-wrap items-center max-desktop:pt-5 max-tablet:pt-5'>
        <div className="flex w-full max-desktop:flex-col max-tablet:flex-col gap-4">
          <FormControl className="w-full max-desktop:w-[80%] max-tablet:w-full ">
            <InputAdminField style={{ marginBottom: '2rem' }}  type='number' onChange={handleChange} value={values?.num_campaigns} placeholder={"Placeholder Text"} label={"No. of campaigns to show"} name={"num_campaigns"} />
          </FormControl>
          <FormControl className="w-full max-desktop:w-[80%] max-tablet:w-full ">
         <InputAdminField label={"File size allowed"}  type='number' value={values?.max_file_size} onChange={handleChange} placeholder={"Placeholder Text"} name={"max_file_size"} />
        ...
        <div className="flex w-full mb-24 max-desktop:flex-col max-tablet:flex-col flex-wrap pt-2 gap-4">
          <div className="w-[40%] max-desktop:w-[80%] max-tablet:w-full">
            ...
            <div className="flex justify-center items-center">
              <InputAdminField label={""} size="lg" value={values?.donation_min_amount} onChange={handleChange}  type='number' name={'donation_min_amount'} placeholder="Minimum" />
              <h1 className='px-2  ' style={styleLabel}>To</h1>
              <InputAdminField size="lg" name={"donation_max_amount"}  value={values?.donation_max_amount} onChange={handleChange} type='number' placeholder="Maximum" />
          ...
          <div className="w-[40%] max-desktop:w-[80%] max-tablet:w-full">
            ...
            <div className="flex justify-center items-center">
              <InputAdminField size="lg"  type='number' name={'campaign_min_amount'} onChange={handleChange} value={values?.campaign_min_amount}  placeholder="Minimum" />
              <h1 className='px-2  ' style={styleLabel}>To</h1>
              <InputAdminField size="lg"  type='number' name={"campaign_max_amount"} onChange={handleChange} value={values?.campaign_max_amount}  placeholder="Maximum" />
