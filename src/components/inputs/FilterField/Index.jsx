...
function Index({ sendCategoryToParent, sendLocationToParent }) {
  ...
  const CustomIcon = () => (
    <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.1927 1.70635L7.94268 7.95635C7.88463 8.01446 7.8157 8.06056 7.73983 8.09201C7.66396 8.12346 7.58263 8.13965 7.50049 8.13965C7.41836 8.13965 7.33703 8.12346 7.26115 8.09201C7.18528 8.06056 7.11635 8.01446 7.0583 7.95635L0.808305 1.70635C0.720798 1.61894 0.661193 1.50753 0.637036 1.38623C0.61288 1.26492 0.625258 1.13918 0.672603 1.02492C0.719948 0.910652 0.800132 0.813004 0.903003 0.744335C1.00587 0.675666 1.12681 0.639063 1.25049 0.63916H13.7505C13.8742 0.639063 13.9951 0.675666 14.098 0.744335C14.2009 0.813004 14.281 0.910652 14.3284 1.02492C14.3757 1.13918 14.3881 1.26492 14.3639 1.38623C14.3398 1.50753 14.2802 1.61894 14.1927 1.70635Z" fill="url(#paint0_linear_4686_9002)" />
      <defs>
        <linearGradient id="paint0_linear_4686_9002" x1="0.625" y1="8.13965" x2="9.00864" y2="2.98968" gradientUnits="userSpaceOnUse">
  ...
  return (
    <>
      <div className="extra-filter-options flex items-center gap-x-[40px] mt-[20px] max-tablet:flex-col max-tablet:gap-y-[20px]">
        <div className='extra-filter-category flex'> <span className='font-[Satoshi] font-bold text-[18px] items-center flex mr-[12px]'>Category: </span>
            ...
            >
              {uniqueCategory.map((item, index) => (
                <MenuItem key={item} value={item} sx={{
                  ...
                  <Checkbox checked={selectedCategories.indexOf(item) > -1} sx={{
                    fontFamily: "Satoshi",
                    fontSize: "18px",
                    fontWeight: "400",
                    marginRight: '17px',
        ...
        <div className='extra-filter-location flex'><span className='font-[Satoshi] font-bold text-[18px] items-center flex mr-[12px]'> Location: </span>
          <FormControl sx={{ width: 150 }}>
            <InputLabel id="demo-multiple-checkbox-label" ></InputLabel>
            <Select
              labelId="demo-multiple-checkbox-label"
            ...
            >
              {uniqueLocations.map((item) => (
                <MenuItem key={item} value={item} sx={{
                  ...
                  <Checkbox checked={selectedLocations.indexOf(item) > -1} sx={{
                    fontFamily: "Satoshi",
                    fontSize: "18px",
                    fontWeight: "400",
                    marginRight: '17px',
