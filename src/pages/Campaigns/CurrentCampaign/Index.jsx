...
function CurrentCampaign({key,username,cardImage,goalAmount,fundRaised,daysLeft,userCount,location , og_id}) {
  const navigate = useNavigate();
  const { pathname } = useLocation();
  const { id } = useParams();
      ...
      >
        ...
        <div className="w-full h-full  flex  gap-5">
          ...
          >
            ...
            >
              ...
              - This campaign will collect all funds raised by {cardDetails?.end_date}
            </p>
            <PrimaryButton
            sx={{width:'80%',padding:'16px',borderRadius:'8px'}}
                // style={{
        ...
        <div className="flex justify-start gap-5 w-full">
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-10">
                ...
                <Avatar
                    ...
                    />
                  <h1 className="col-span-7 text-5xl flex items-center font-bold" style={{fontFamily:'satoshi'}}>
                  {cardDetails?.user}
                  </h1> 
                </div>
              </div>
              <div className="col-span-2 flex justify-center items-center ">
                <button className="justify-center items-center  px-4 py-2" style={{background: '#FFF6F5', borderRadius: 8, border: '1px red solid',  gap: 12, display: 'inline-flex'}}>
                  <div style={{width: 32, height: 32, position: 'relative'}}>
                     <img src={images.ShareNetwork} alt="" />
                  </div>
          ...
          <div className="w-[37%] flex pt-2 pl-5  pb-12" style={{background: 'white', borderRadius: 20, flexDirection: 'column', gap: 24, display: 'inline-flex'}}>
            ...
            <h1 className="text-3xl w-[80%] flex justify-items-start  pb-2  " style={{fontFamily:'satoshi',fontWeight:700,background:"linear-gradient(to right, #FF9F0A 0%, #FF375F 62.9%)","-webkit-background-clip": "text","-webkit-text-fill-color": "transparent" }}>Recent Donors:</h1>
            <div className="">
