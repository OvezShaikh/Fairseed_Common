...
function CurrentCampaign({
  ...
  return (
    <>
      ...
      <div
        className="px-[80px] gap-[48px] max-tablet:gap-[28px] py-5 max-desktop:w-full max-desktop:px-[28px] max-desktop:place-content-center max-tablet:px-[16px]"
        style={{
          width: "100%",
          height: "100%",
          flexDirection: "column",
      ...
      >
        ...
        <div className="w-full desktop:h-[862px] max-desktop:gap-3 desktop:gap-[36px] desktop:flex max-desktop:flex-col max-desktop:place-content-center max-desktop:w-full">
          <img
            className="w-[65%] rounded-3xl max-desktop:w-full desktop:object-cover max-desktop:pb-[48px] max-tablet:pb-[28px]"
          ...
          >
            ...
            <p
              className="text-black/40 w-full text-2xl text-center py-10 max-desktop:w-full max-tablet:py-[24px] max-tablet:text-[18px] max-tablet:py-[24px] font-medium max-tablet:leading-5"
              style={{ fontFamily: "satoshi" }}
            >
  ...
  <div className="pt-4" dangerouslySetInnerHTML={{ __html: cardDetails.story }} style={{whiteSpace:"pre-line"}}></div>
          ...
          <div
            className="w-[37%] flex pt-2 pl-5  pb-12 max-desktop:pl-0 max-tablet:w-[100%]"
            style={{
              background: "white",
              borderRadius: 20,
              flexDirection: "column",
